        ...
        <div className="px-6 py-5">
          ...
          {step === 'form' && (
            <form onSubmit={handleSubmit} className="space-y-4">
              <Field
                label="Display Name"
                hint="How this source will appear in SATORI"
                required
              >
                <input
                  type="text"
                  ...
                  placeholder="e.g. Dispatch Group, Safety Channel"
              ...
              <Field
                ...
                hint={
                  <>
                    The numeric ID of the group or channel.{' '}
                    <a
                    ...
                    — forward a message from the group to get its ID.
                  </>
                }
                required
              >
                <input
                  ...
                  className="satori-input font-mono"
                />
              </Field>
          ...
          {step === 'instructions' && (
            <div className="space-y-4">
              ...
              <Field
                label="Bot Token"
                hint="From @BotFather — starts with a number followed by a colon"
              >
              ...
              <Field label="Webhook URL" hint="This is where Telegram will POST all messages">
                <div
                  className="flex items-center gap-2 px-3 py-2 rounded-lg font-mono text-[11px] select-all"
                  style={{
              ...
              >
                ...
                <code
                  className="block text-[10px] p-2 rounded overflow-x-auto"
          ...
          {step === 'done' && (
            <div className="flex flex-col items-center gap-4 py-4 text-center">
              ...
              <button className="btn-accent w-full" onClick={onClose}>
                Done
              </button>
            </div>
          )}
